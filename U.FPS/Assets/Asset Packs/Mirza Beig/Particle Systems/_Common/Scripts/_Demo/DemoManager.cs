        ...
        namespace Demos
        {
            ...
            public class DemoManager : MonoBehaviour
            {
                ...
                void Start()
                {
                    ...
                    mouseParticlesToggle.isOn = mouseFollow.gameObject.activeSelf;
                }
                ...
                {
                    mouseFollow.gameObject.SetActive(value);
                }
                ...
                void Update()
                {
                    ...
                    if (particleMode == ParticleMode.oneshot)
                    {    //    TODO : re-enable input if i need want to show off the demo scene
                        /*Vector3 mousePosition = new Vector3(myMouse.position.x.ReadValue(), myMouse.position.y.ReadValue(), 0f);
                        ...
                        if (myMouse.leftButton.wasPressedThisFrame)
                        {
                            ...
                            oneshotParticleSystems.InstantiateParticlePrefab(mousePosition, mouseFollow.distanceFromCamera);
                        }
